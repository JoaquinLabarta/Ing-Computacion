...
node aws-iot-device-sdk-js-v2/samples/node/pub_sub/dist/index.js --endpoint a19dtnoi0vf30n-ats.iot.us-west-2.amazonaws.com --key A11.private.key --cert A11.cert.pem --ca_file root-CA.crt --client_id sdk-nodejs-v2 --topic sdk/test/js